import { SET_BLOG_POSTS, SET_PROJECT_POSTS, SET_CATEGORY_POSTS } from './mutations.type'
...
export const actions = {
  ...
  async nuxtServerInit({ commit }) {
    ...
    let categoryFiles = await require.context('~/assets/content/category/', false, /\.json$/)
    await commit(SET_CATEGORY_POSTS, actions.getPosts(categoryFiles))
